...
def red4_run_and_log(search_fn: Callable[[int, str], Tuple], number_evaluations: int, config_filename:str, result_filename: str):
    res = search_fn(number_evaluations, config_filename)
    global_fittest, evaluations, best_penalized_fitness, \
        mean_penalized_fitness, best_base_fitness, mean_base_fitness, gp_log = res
    saved_data = {
...
def red4_genetic_programming_search(number_evaluations, config_filename) -> Tuple[TreeGenotype, ...]:
