...
def red2_run_and_log(search_fn: Callable[[int, str], Tuple], number_evaluations: int, config_filename:str, result_filename: str):
...
def red2_genetic_programming_search(number_evaluations, config_filename) -> Tuple[TreeGenotype, ...]:
