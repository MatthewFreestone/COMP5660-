...
def red3_run_and_log(search_fn: Callable[[int, str], dict], number_evaluations: int, config_filename:str, result_filename: str):
    res = search_fn(number_evaluations, config_filename)
    with open(result_filename, 'w') as f:
        json.dump(res, f, indent=2)


def red3_genetic_programming_search(number_evaluations, config_filename) -> dict:
